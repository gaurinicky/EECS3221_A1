...
//this will compare the process IDs -- similar to compare by arrival
...
//we have to prnt out the result -- to make it easier we make a final function
void printResult(float avgWait, float avgTurn, int finish, float used, int context, int pid, int qTime)
{
	printf("------------------------------------rr q = %d -----------------------------\n", qTime);
